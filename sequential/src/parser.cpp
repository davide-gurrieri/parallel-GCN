...
/**
 * By parsing the .graph file containing the ordered edgelist of the graph it populates a CSR representation of the graph
*/
void Parser::parseGraph() {
    ...
    while(true) {
        ...
        // iterate over the neighbours of the current node in order to populate the CSR
...
/**
 * The SVMLight allows for storing features in a sparse way therefore even the features are stored using a CSR approach to index the data in feature_val
*/
